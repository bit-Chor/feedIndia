...
// mongoose.connect("mongodb+srv://Sparsh:sparsh@123@cluster0-609in.mongodb.net/feedIndia?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true });
mongoose.connect('mongodb://localhost:27017/feedIndia', { useNewUrlParser: true });
...
Admin.create(x, function(err, user) {
    // console.log(user);
    try {
        console.log(user);
...
app.listen(3000, function() {
    console.log("Listening to feedIndia");
});